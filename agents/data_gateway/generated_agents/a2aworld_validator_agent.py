"""
A2AWORLD_VALIDATOR_AGENT - Data Gateway Agent for Terra Constellata
...
class A2aworldValidator(DataGatewayAgent):
    """
    A2AWORLD_VALIDATOR_AGENT data gateway agent.

    Provides access to Infrastructure data from A2A World Foundation.

    Capabilities: validate_a2a_message, validate_agent_card
    """

    def __init__(self, llm, tools: List = None, **kwargs):
        """
        Initialize the A2AWORLD_VALIDATOR_AGENT agent.
        ...
        default_config = {
            ...
            "api_key": "{{SECRETS.A2AWORLD_VALIDATOR_AGENT_API_KEY}}",
        ...
        super().__init__(
            agent_name="A2AWORLD_VALIDATOR_AGENT",
        ...
        logger.info(f"Initialized A2AWORLD_VALIDATOR_AGENT for Infrastructure data access")
