"""
A2AWORLD_NEWS_AGENT - Data Gateway Agent for Terra Constellata
...
class A2aworldNews(DataGatewayAgent):
    """
    A2AWORLD_NEWS_AGENT data gateway agent.

    Provides access to Infrastructure data from A2A World Foundation.

    Capabilities: get_latest_announcements
    """

    def __init__(self, llm, tools: List = None, **kwargs):
        """
        Initialize the A2AWORLD_NEWS_AGENT agent.
        ...
        default_config = {
            ...
            "api_key": "{{SECRETS.A2AWORLD_NEWS_AGENT_API_KEY}}",
        ...
        super().__init__(
            agent_name="A2AWORLD_NEWS_AGENT",
        ...
        logger.info(f"Initialized A2AWORLD_NEWS_AGENT for Infrastructure data access")
