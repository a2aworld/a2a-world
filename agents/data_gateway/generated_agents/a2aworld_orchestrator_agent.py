"""
A2AWORLD_ORCHESTRATOR_AGENT - Data Gateway Agent for Terra Constellata
...
class A2aworldOrchestrator(DataGatewayAgent):
    """
    A2AWORLD_ORCHESTRATOR_AGENT data gateway agent.

    Provides access to Infrastructure data from A2A World Foundation.

    Capabilities: submit_workflow_task, get_workflow_status
    """

    def __init__(self, llm, tools: List = None, **kwargs):
        """
        Initialize the A2AWORLD_ORCHESTRATOR_AGENT agent.
        ...
        default_config = {
            ...
            "api_key": "{{SECRETS.A2AWORLD_ORCHESTRATOR_AGENT_API_KEY}}",
        ...
        super().__init__(
            agent_name="A2AWORLD_ORCHESTRATOR_AGENT",
        ...
        logger.info(f"Initialized A2AWORLD_ORCHESTRATOR_AGENT for Infrastructure data access")
