"""
A2AWORLD_REPUTATION_AGENT - Data Gateway Agent for Terra Constellata
...
class A2aworldReputation(DataGatewayAgent):
    """
    A2AWORLD_REPUTATION_AGENT data gateway agent.

    Provides access to Infrastructure data from A2A World Foundation.

    Capabilities: submit_interaction_rating, get_agent_reputation_score
    """

    def __init__(self, llm, tools: List = None, **kwargs):
        """
        Initialize the A2AWORLD_REPUTATION_AGENT agent.
        ...
        default_config = {
            ...
            "api_key": "{{SECRETS.A2AWORLD_REPUTATION_AGENT_API_KEY}}",
        ...
        super().__init__(
            agent_name="A2AWORLD_REPUTATION_AGENT",
        ...
        logger.info(f"Initialized A2AWORLD_REPUTATION_AGENT for Infrastructure data access")
