"""
A2AWORLD_REGISTRY_AGENT - Data Gateway Agent for Terra Constellata
...
class A2aworldRegistry(DataGatewayAgent):
    """
    A2AWORLD_REGISTRY_AGENT data gateway agent.

    Provides access to Infrastructure data from A2A World Foundation.

    Capabilities: register_agent, discover_agents_by_capability
    """

    def __init__(self, llm, tools: List = None, **kwargs):
        """
        Initialize the A2AWORLD_REGISTRY_AGENT agent.
        ...
        default_config = {
            ...
            "api_key": "{{SECRETS.A2AWORLD_REGISTRY_AGENT_API_KEY}}",
        ...
        super().__init__(
            agent_name="A2AWORLD_REGISTRY_AGENT",
        ...
        logger.info(f"Initialized A2AWORLD_REGISTRY_AGENT for Infrastructure data access")
