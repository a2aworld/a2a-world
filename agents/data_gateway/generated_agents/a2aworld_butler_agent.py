"""
A2AWORLD_BUTLER_AGENT - Data Gateway Agent for Terra Constellata
...
class A2aworldButler(DataGatewayAgent):
    """
    A2AWORLD_BUTLER_AGENT data gateway agent.

    Provides access to Infrastructure data from A2A World Foundation.

    Capabilities: request_new_via_instantiation
    """

    def __init__(self, llm, tools: List = None, **kwargs):
        """
        Initialize the A2AWORLD_BUTLER_AGENT agent.
        ...
        default_config = {
            ...
            "api_key": "{{SECRETS.A2AWORLD_BUTLER_AGENT_API_KEY}}",
        ...
        super().__init__(
            agent_name="A2AWORLD_BUTLER_AGENT",
        ...
        logger.info(f"Initialized A2AWORLD_BUTLER_AGENT for Infrastructure data access")
